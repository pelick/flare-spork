...
public class DistinctConverter implements POConverter<Tuple, Tuple, PODistinct> {
    ...
    public RDD<Tuple> convert(List<RDD<Tuple>> predecessors, PODistinct poDistinct) throws IOException {
        ...
        ClassTag<Tuple2<Tuple, Object>> tuple2ClassTag = SparkUtil.<Tuple, Object>getTuple2ClassTag();
        ...
        PairRDDFunctions<Tuple, Object> pairRDDFunctions = 
                new PairRDDFunctions<Tuple, Object>(rddPairs, SparkUtil.getClassTag(Tuple.class), SparkUtil.getClassTag(Object.class));
        
        int parallelism = SparkUtil.getParallelism(predecessors, poDistinct);
        
        return pairRDDFunctions.reduceByKey(MERGE_VALUES_FUNCTION, parallelism).map(TO_VALUE_FUNCTION, SparkUtil.getClassTag(Tuple.class));
    }
